...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col">
        ...
        <!--Container Table-->
        <?php require_once('../app/Views/documentTypes/table.php') ?>
        <!--End Container Table-->
      </div>
    </div>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!--Form-->
          <?php require_once('../app/Views/documentTypes/form.php') ?>
          <!--End Form-->
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="submit" form="documentType-form" id="btn_Submit" class="btn btn-primary">Send Data</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <!--JS Controller-->
  <script src="../controllers/documentTypes/documentTypes.js"></script>
</body>
