<div class="modal fade" id="management-modal" tabindex="-1" aria-labelledby="management-modalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="management-modalLabel">MANAGEMENT GROUPS</h5>
