<div class="modal fade" id="assessment-modal" tabindex="-1" aria-labelledby="assessment-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" form="assessment-form" id="btn_assessment_form" class="btn btn-primary" disabled>Send Data</button>
        </div>
      </div>
    </div>
  </div>