            ...
            <div class="row">
                <div class="col-6 mx-auto">
                    ...
                    <button type="button" class="btn btn-success"
                        onclick="createUser('form_login')"><img
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5"
                            id="modalUserLabel">Modal User</h1>
                                    ...
                                    <div class="mb-3 col-6">
                                        <label for="User_password"
                                            ...
                                            <button
                                                ...
                                                type="button"
                                                id="btnViewPass" onclick="viewPassword(this.id)" ><img
                                                src="../../../public/assets/img/icons/eye-slash-fill.svg"></button></div>
                                    ...
                                    <div class="mb-3  col-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <button
                                                class="btn btn-primary"
                                                type="button"
                                                id="btnViewPass2" onclick="viewPassword(this.id)"><img
                                                src="../../../public/assets/img/icons/eye-slash-fill.svg"></button>
                                        </div>
