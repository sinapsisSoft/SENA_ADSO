document.addEventListener('DOMContentLoaded', async () => {
  ...
  await checkAuth();
  console.log('Role module controller has been loaded');
...
const objForm = new Form('roleModuleForm', 'edit-input');
...
<td>${row.id}</td>
<td>${row.module_fk}</td>
<td>${row.role_user_fk}</td>
<td>  <input class="form-check-input" type="checkbox" role="switch" id="switchCheckDefault" disabled="disabled" value="${row.can_view}" ${row.can_view === 1 ? "checked" : ""}></td>
<td>  <input class="form-check-input" type="checkbox" role="switch" id="switchCheckDefault" disabled="disabled" value="${row.can_create}" ${row.can_create === 1 ? "checked" : ""}></td>
<td> <input class="form-check-input" type="checkbox" role="switch" id="switchCheckDefault" disabled="disabled" value="${row.can_edit}" ${row.can_edit === 1 ? "checked" : ""}></td>
<td>  <input class="form-check-input" type="checkbox" role="switch" id="switchCheckDefault" disabled="disabled" value="${row.can_delete}" ${row.can_delete === 1 ? "checked" : ""}></td>
<td>
